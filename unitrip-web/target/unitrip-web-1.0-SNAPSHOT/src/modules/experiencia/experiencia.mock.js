...
(function (ng) {
    ...
    var mod = ng.module('experienciaMock', ['ngMockE2E']);
    ...
    mod.run(['$httpBackend', function ($httpBackend) {
             ...
             */
            var recordUrl = new RegExp('api/experiencias/([0-9]+)');
             ...
             */
            $httpBackend.whenGET('api/experiencias').respond(function (method, url) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/experiencias/[numero]"
             ...
             */
            $httpBackend.whenPOST('api/experiencias').respond(function (method, url, data) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud DELETE a la url "api/experiencias/[numero]"
