...
(function (ng) {
    ...
    mod.run(['$httpBackend', function ($httpBackend) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/eventos"
             ...
             */
            $httpBackend.whenGET('api/eventos').respond(function (method, url) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/eventos/[numero]"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud POST a la url "api/eventos"
             ...
             */
            $httpBackend.whenPOST('api/eventos').respond(function (method, url, data) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud DELETE a la url "api/eventos/[numero]"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud PUT a la url "api/eventos/[numero]"
