...
(function (ng) {
    ...
    var mod = ng.module('paradaMock', ['ngMockE2E']);
    ...
    mod.run(['$httpBackend', function ($httpBackend) {
         ...
         * ej: api/paradas/1
         */
        var recordUrl = new RegExp('api/paradas/([0-9]+)');
        
        /*
         * @type Array
         * records: Array con una parada por defecto
         */
        var records = [{
                id: 0,
                name: 'Parada 1',
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/paradas"
         ...
         */ 
        $httpBackend.whenGET('api/paradas').respond(function (method, url) {
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/paradas/[numero]"
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud POST a la url "api/paradas"
         ...
         */
        $httpBackend.whenPOST('api/paradas').respond(function (method, url, data) {
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud DELETE a la url "api/paradas/[numero]"
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud PUT a la url "api/paradas/[numero]"
