...
(function (ng) {
    ...
    mod.run(['$httpBackend', function ($httpBackend) {
             ...
             * ej: api/tasks/1
             */
            var recordUrl = new RegExp('api/parada/([0-9]+)');
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/parada"
             ...
             */
            $httpBackend.whenGET('api/parada').respond(function (method, url) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/parada/[numero]"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud POST a la url "api/parada"
             ...
             */
            $httpBackend.whenPOST('api/parada').respond(function (method, url, data) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud PUT a la url "api/parada/[numero]"
