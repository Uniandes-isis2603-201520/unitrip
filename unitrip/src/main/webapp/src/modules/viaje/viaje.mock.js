...
(function (ng) {
    ...
    var mod = ng.module('viajeMock', ['ngMockE2E']);
    ...
    mod.run(['$httpBackend', function ($httpBackend) {
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/viajes"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/viajes/[numero]"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud POST a la url "api/viajes"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud DELETE a la url "api/viajes/[numero]"
            ...
            /*
             * Esta funcion se ejecuta al invocar una solicitud PUT a la url "api/viajes/[numero]"
